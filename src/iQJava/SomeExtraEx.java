...
public class SomeExtraEx {
	public static void main(String[] args) {
		...
		System.out.println(
				"ODOMETER SAMPLE CANCELLED OUT BECAUSE PROGRAM IS VERY LONG SO MAKE SURE TO UNCOMMENT IT TO SEE IT!");
		System.out.println();
		System.out.println(
				"XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX\"");
		// THIS WAS CANCELLED BECAUSE PRINTING OF THIS PROGRAM IS VERY LONG AND YOU WONT
		// TO SEE PRINTING OF OTHER PROGRAMS -
